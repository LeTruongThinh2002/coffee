...
<div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item active text-white">Change email</li>
            </ol>
        </div>
            ...
            <div class="col-lg-8 col-xl-8">
                <div class="row g-4 bg-light rounded">
                    ...
                    <div class="col-lg-6 text-center">
                        <div class="mb-3">
                            <span style="font-weight: bold;color: transparent;font-size: 7vh;background-image: url(/images/page/giphy2.webp); background-position: center; background-size: cover; -moz-background-clip: text; -webkit-background-clip: text;">Change Email</span>
                        </div>
